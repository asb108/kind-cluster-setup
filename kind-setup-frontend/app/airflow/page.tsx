          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <CardDescription>Open-source platform for developing, scheduling, and monitoring batch-oriented workflows</CardDescription>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-500">Deployment Method</p>
                  <p>kubectl</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                <div>
                  <p className="text-sm font-medium text-gray-500">Access URL</p>
                  <p className="text-blue-500 break-all">
                    <a href="http://localhost:30081" target="_blank" rel="noopener noreferrer">
                      http://localhost:30081
                    </a>
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Login Credentials</p>
