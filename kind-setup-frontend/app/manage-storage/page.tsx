...
const getStatusColor = (status: string) => {
  switch (status.toLowerCase()) {
    case 'bound': return 'bg-green-100 text-green-800 border-green-200'
    case 'pending': return 'bg-yellow-100 text-yellow-800 border-yellow-200'
    case 'available': return 'bg-blue-100 text-blue-800 border-blue-200'
    case 'failed': return 'bg-red-100 text-red-800 border-red-200'
    case 'released': return 'bg-gray-100 text-gray-800 border-gray-200'
...
export default function ManageStorage() {
  ...
  const filteredPVs = persistentVolumes.filter(pv => 
    ...
    (searchTerm === '' || pv.name.toLowerCase().includes(searchTerm.toLowerCase()))
  )

  const filteredPVCs = persistentVolumeClaims.filter(pvc => 
    (selectedCluster === 'all' || pvc.cluster === selectedCluster) &&
    (searchTerm === '' || pvc.name.toLowerCase().includes(searchTerm.toLowerCase()) || 
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage storage resources across your Kind clusters</p>
          </div>
        </div>
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={loadStorageData} disabled={loading}>
      ...
      {storageOverview && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{storageOverview.total_pvs}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{storageOverview.total_pvcs}</div>
              <p className="text-xs text-muted-foreground">
                Active claims
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{storageOverview.total_storage_classes}</div>
              <p className="text-xs text-muted-foreground">
                Available classes
              </p>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{storageOverview.total_capacity}</div>
              <p className="text-xs text-muted-foreground">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="persistent-volumes">Persistent Volumes</TabsTrigger>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Storage utilization across clusters</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {Object.entries(storageOverview.metrics_by_cluster).map(([cluster, metrics]) => (
                    <div key={cluster} className="space-y-2">
                      ...
                      <Progress value={metrics.utilization_percentage} className="h-2" />
                      <div className="flex justify-between text-xs text-muted-foreground">
                        <span>{metrics.pv_count} PVs, {metrics.pvc_count} PVCs</span>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Latest storage-related events</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">PVC postgres-pvc bound successfully</p>
                        <p className="text-xs text-muted-foreground">kind-dev • 2 minutes ago</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                      <div className="flex-1">
                        <p className="text-sm font-medium">Storage class fast-ssd created</p>
                        <p className="text-xs text-muted-foreground">kind-dev • 1 hour ago</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                      <div className="flex-1">
                        <p className="text-sm font-medium">PV pvc-mysql-data provisioned</p>
                        <p className="text-xs text-muted-foreground">kind-dev • 3 hours ago</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => showResourceDetails(storageClass, 'storage-class')}
                      >
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground">{storageClass.reclaim_policy}</p>
                    </div>
                    <div>
                      <span className="font-medium">Binding Mode:</span>
                      <p className="text-muted-foreground">{storageClass.volume_binding_mode}</p>
                    </div>
                    <div>
                      <span className="font-medium">Expansion:</span>
                      <p className="text-muted-foreground">
                        {storageClass.allow_volume_expansion ? 'Allowed' : 'Not Allowed'}
                      </p>
                    </div>
                    <div>
                      <span className="font-medium">Created:</span>
                      <p className="text-muted-foreground">{formatDate(storageClass.created_at)}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => showResourceDetails(pv, 'persistent-volume')}
                      >
                        <Eye className="h-4 w-4 mr-2" />
                        Details
                      </Button>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground">{pv.access_modes.join(', ')}</p>
                    </div>
                    <div>
                      <span className="font-medium">Reclaim Policy:</span>
                      <p className="text-muted-foreground">{pv.reclaim_policy}</p>
                    </div>
                    <div>
                      <span className="font-medium">Storage Class:</span>
                      <p className="text-muted-foreground">{pv.storage_class || 'N/A'}</p>
                    </div>
                    <div>
                      <span className="font-medium">Claim:</span>
                      <p className="text-muted-foreground">{pv.claim || 'Unbound'}</p>
                    </div>
                  </div>
                  {pv.host_path && (
                    <div className="mt-3 pt-3 border-t">
                      <span className="font-medium text-sm">Host Path:</span>
                      <p className="text-sm text-muted-foreground font-mono">{pv.host_path}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => showResourceDetails(pvc, 'persistent-volume-claim')}
                      >
                        <Eye className="h-4 w-4 mr-2" />
                        Details
                      </Button>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground">{pvc.requested_storage}</p>
                    </div>
                    <div>
                      <span className="font-medium">Capacity:</span>
                      <p className="text-muted-foreground">{pvc.capacity || 'N/A'}</p>
                    </div>
                    <div>
                      <span className="font-medium">Used:</span>
                      <p className="text-muted-foreground">{pvc.used_storage || 'N/A'}</p>
                    </div>
                    <div>
                      <span className="font-medium">Access Modes:</span>
                      <p className="text-muted-foreground">{pvc.access_modes.join(', ')}</p>
                    </div>
                  </div>
                  <div className="mt-3 pt-3 border-t">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="font-medium">Storage Class:</span>
                        <p className="text-muted-foreground">{pvc.storage_class || 'Default'}</p>
                      </div>
                      <div>
                        <span className="font-medium">Volume:</span>
                        <p className="text-muted-foreground">{pvc.volume || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {resourceType === 'persistent-volume' && 'Persistent Volume Details'}
              {resourceType === 'persistent-volume-claim' && 'Persistent Volume Claim Details'}
            </DialogTitle>
            <DialogDescription>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{selectedResource.cluster}</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{selectedResource.provisioner}</p>
                    </div>
                    <div>
                      <Label className="font-medium">Reclaim Policy</Label>
                      <p className="text-sm text-muted-foreground">{selectedResource.reclaim_policy}</p>
                    </div>
                    <div>
                      <Label className="font-medium">Volume Binding Mode</Label>
                      <p className="text-sm text-muted-foreground">{selectedResource.volume_binding_mode}</p>
                    </div>
                    <div>
                      <Label className="font-medium">Allow Volume Expansion</Label>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <div className="mt-2 space-y-1">
                          {Object.entries(selectedResource.parameters).map(([key, value]) => (
              ...
              {(resourceType === 'persistent-volume' || resourceType === 'persistent-volume-claim') && (
                <div className="space-y-4">
                  <Separator />
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {selectedResource.capacity || selectedResource.requested_storage}
                      </p>
                    </div>
                    <div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{formatDate(selectedResource.created_at)}</p>
              </div>
            </div>
          )}
        </DialogContent>
