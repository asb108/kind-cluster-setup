...
export default function Settings() {
  ...
  const [clusterDefaults, setClusterDefaults] = useState<ClusterDefaults>(mockClusterDefaults)
  ...
  // Other states
  const [validationErrors, setValidationErrors] = useState<SettingsValidation[]>([])
  const [showAdvancedOptions, setShowAdvancedOptions] = useState(false)
  const [configBackups, setConfigBackups] = useState<ConfigurationBackup[]>(mockBackups)
  ...
  const validateSettings = (): SettingsValidation[] => {
    ...
    if (notificationSettings.email_notifications && !notificationSettings.email_address) {
      errors.push({
        field: 'email_address',
  ...
  const importConfiguration = async () => {
    try {
      ...
      if (config.system_preferences) setSystemPreferences(config.system_preferences)
      if (config.security_settings) setSecuritySettings(config.security_settings)
      if (config.notification_settings) setNotificationSettings(config.notification_settings)
      if (config.advanced_settings) setAdvancedSettings(config.advanced_settings)
      ...
      toast({
        ...
        description: "Configuration has been imported successfully. Don't forget to save your changes.",
      })
  ...
  const resetToDefaults = () => {
    ...
    toast({
      ...
      description: "All settings have been reset to defaults. Don't forget to save your changes.",
    })
  }
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Configure your application preferences and system settings</p>
          </div>
        </div>
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6">
          ...
          <TabsTrigger value="cluster-defaults" className="flex items-center gap-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('user-preferences', 'theme', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('user-preferences', 'language', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('user-preferences', 'timezone', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('user-preferences', 'default_cluster_view', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('user-preferences', 'show_system_components', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('user-preferences', 'compact_mode', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('user-preferences', 'notifications_enabled', checked)}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label>Refresh Interval: {userPreferences.auto_refresh_interval / 1000}s</Label>
                  <Slider
                    value={[userPreferences.auto_refresh_interval]}
                    onValueChange={([value]) => handleSettingChange('user-preferences', 'auto_refresh_interval', value)}
                    max={30000}
                    min={1000}
                    step={1000}
                    className="w-full"
        ...
        <TabsContent value="cluster-defaults" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set default values for new cluster creation</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('cluster-defaults', 'default_worker_nodes', parseInt(e.target.value))}
                  />
                  <p className="text-sm text-muted-foreground">Number of worker nodes to create by default</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('cluster-defaults', 'default_cpu_limit', e.target.value)}
                    placeholder="2"
                  />
                  <p className="text-sm text-muted-foreground">CPU limit per node (e.g., 2, 4)</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('cluster-defaults', 'default_memory_limit', e.target.value)}
                    placeholder="4Gi"
                  />
                  <p className="text-sm text-muted-foreground">Memory limit per node (e.g., 4Gi, 8Gi)</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('cluster-defaults', 'default_storage_class', e.target.value)}
                    placeholder="standard"
                  />
                  <p className="text-sm text-muted-foreground">Default storage class for persistent volumes</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('cluster-defaults', 'default_namespace', e.target.value)}
                    placeholder="default"
                  />
                  <p className="text-sm text-muted-foreground">Default namespace for application deployments</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('cluster-defaults', 'kind_image_version', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                  ...
                  <p className="text-sm text-muted-foreground">Kubernetes version for new clusters</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('cluster-defaults', 'enable_ingress', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('cluster-defaults', 'enable_metrics_server', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('cluster-defaults', 'enable_dashboard', checked)}
                    />
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="api-settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure API connection and behavior settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('api-settings', 'api_base_url', e.target.value)}
                    placeholder="http://localhost:8020"
                  />
                  <p className="text-sm text-muted-foreground">Base URL for the backend API</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('api-settings', 'request_timeout', parseInt(e.target.value))}
                  />
                  <p className="text-sm text-muted-foreground">Timeout for API requests in milliseconds</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('api-settings', 'retry_attempts', parseInt(e.target.value))}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('api-settings', 'polling_interval', parseInt(e.target.value))}
                  />
                  <p className="text-sm text-muted-foreground">Interval for status polling in milliseconds</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('api-settings', 'max_concurrent_requests', parseInt(e.target.value))}
                  />
                  <p className="text-sm text-muted-foreground">Maximum number of concurrent API requests</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('api-settings', 'enable_debug_mode', checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handleSettingChange('api-settings', 'enable_mock_data', checked)}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('security-settings', 'enable_rbac', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={securitySettings.require_confirmation_for_destructive_actions}
                    onCheckedChange={(checked) => handleSettingChange('security-settings', 'require_confirmation_for_destructive_actions', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('security-settings', 'enable_audit_logging', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('security-settings', 'scan_images_for_vulnerabilities', checked)}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('security-settings', 'session_timeout', parseInt(e.target.value))}
                  />
                  <p className="text-sm text-muted-foreground">Automatic logout after inactivity</p>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="allowed-registries">Allowed Container Registries</Label>
                  <Textarea
                    value={securitySettings.allowed_registries.join('\n')}
                    onChange={(e) => handleSettingChange('security-settings', 'allowed_registries', e.target.value.split('\n').filter(r => r.trim()))}
                    placeholder="docker.io&#10;gcr.io&#10;quay.io"
                    rows={4}
                  />
                  <p className="text-sm text-muted-foreground">One registry per line. Leave empty to allow all registries.</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('notification-settings', 'email_notifications', checked)}
                  />
                </div>
                ...
                {notificationSettings.email_notifications && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('notification-settings', 'email_address', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('notification-settings', 'webhook_url', e.target.value)}
                    placeholder="https://your-webhook-url.com"
                  />
                  <p className="text-sm text-muted-foreground">HTTP endpoint to receive notification webhooks</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('notification-settings', 'slack_webhook', e.target.value)}
                    placeholder="https://hooks.slack.com/services/..."
                  />
                  <p className="text-sm text-muted-foreground">Slack incoming webhook URL for notifications</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Notifications for cluster creation, deletion, and status changes
                      </p>
                    </div>
                    <Switch
                      checked={notificationSettings.notification_types.cluster_events}
                      onCheckedChange={(checked) => handleSettingChange('notification-settings', 'notification_types', {
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={notificationSettings.notification_types.deployment_status}
                      onCheckedChange={(checked) => handleSettingChange('notification-settings', 'notification_types', {
                        ...notificationSettings.notification_types,
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={notificationSettings.notification_types.resource_alerts}
                      onCheckedChange={(checked) => handleSettingChange('notification-settings', 'notification_types', {
                        ...notificationSettings.notification_types,
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={notificationSettings.notification_types.system_updates}
                      onCheckedChange={(checked) => handleSettingChange('notification-settings', 'notification_types', {
                        ...notificationSettings.notification_types,
        ...
        <TabsContent value="advanced-settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Advanced system settings and tool paths</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  These are advanced settings. Incorrect values may cause the application to malfunction.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('advanced-settings', 'kubectl_path', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('advanced-settings', 'helm_path', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('advanced-settings', 'kind_path', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('advanced-settings', 'docker_socket_path', e.target.value)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('advanced-settings', 'custom_ca_cert_path', e.target.value)}
                    placeholder="/path/to/ca-cert.pem"
                  />
                  <p className="text-sm text-muted-foreground">Optional custom CA certificate for HTTPS connections</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('advanced-settings', 'proxy_settings', {
                  ...
                  <div className="space-y-4 pl-4 border-l-2 border-gray-200">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleSettingChange('advanced-settings', 'proxy_settings', {
                          ...advancedSettings.proxy_settings,
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-sm text-muted-foreground">Comma-separated list of hosts to bypass proxy</p>
                    </div>
                  </div>
                )}
              </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                This will export all your current settings including user preferences, cluster defaults,
                API settings, and security configuration.
              </AlertDescription>
            </Alert>
          </div>
          <DialogFooter>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            <Alert>
              ...
              <AlertTitle>Warning</AlertTitle>
              <AlertDescription>
                Importing configuration will overwrite your current settings. Make sure to export
