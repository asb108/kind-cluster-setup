...
import { User, Menu, X, Server, LayersIcon, Home, Activity, Terminal, Settings } from 'lucide-react'
...
export default function Navigation({ onMenuClick, sidebarOpen }: NavigationProps) {
  ...
  return (
    <header className={cn(styles.header, scrolled && 'shadow-md backdrop-blur-md')}>
