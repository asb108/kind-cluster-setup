    ...
    <div className='relative'>
      ...
      {isOpen && (
        <div className='absolute right-0 mt-2 w-48 py-2 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50 border border-gray-200 dark:border-gray-700'>
          ...
          >
            <span className='flex items-center justify-center w-5 h-5 bg-[#5E81AC] text-white rounded-full text-xs'>
              N
            </span>
          ...
          >
            <span className='flex items-center justify-center w-5 h-5 bg-[#268BD2] text-white rounded-full text-xs'>
              S
            </span>
          ...
          >
            <span className='flex items-center justify-center w-5 h-5 bg-[#BD93F9] text-white rounded-full text-xs'>
              D
            </span>
