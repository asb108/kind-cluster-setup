...
type AnimationVariant = 'bounce' | 'pulse' | 'scale' | 'shine' | 'slide' | 'none';
...
export function AnimatedButton({
  ...
  const getAnimationProps = () => {
    switch (animation) {
      case 'bounce':
        return {
          whileHover: whileHover || { y: -5, transition: { duration: 0.2, type: 'spring', stiffness: 400 } },
          whileTap: whileTap || { y: 0, scale: 0.97, transition: { duration: 0.1 } },
          initial: { y: 0 },
        };
      case 'pulse':
        return {
