...
class TestDeleteAppCommand(unittest.TestCase):
    ...
    def test_delete_app(self, mock_init):
        ...
        command._delete_from_cluster.assert_called_once_with(self.application, self.cluster.name, 'dev')
    ...
    def test_delete_app_delete_from_cluster_failure(self, mock_init):
        ...
        command._delete_from_cluster = MagicMock(side_effect=Exception("Failed to delete from cluster"))
    ...
    def test_delete_app_delete_config_files_failure(self, mock_init):
        ...
        command._delete_config_files = MagicMock(side_effect=Exception("Failed to delete config files"))
