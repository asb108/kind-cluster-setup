...
class TestModifyCommand(unittest.TestCase):
    ...
    @patch('kind_cluster_setup.core.deployment.DeploymentStrategyFactory.create_default_factory')
    ...
    def test_modify_deployment(self, mock_init, mock_executor, mock_factory, mock_get_env_config, mock_load_app_config):
        ...
        command._cluster_repo.find_by_id.assert_called_once_with(self.application.cluster_id)
    ...
    def test_modify_deployment_config_all_parameters(self):
        ...
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['image'], 'nginx:1.21')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['limits']['cpu'], '500m')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['limits']['memory'], '512Mi')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['requests']['cpu'], '250m')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['requests']['memory'], '256Mi')
    ...
    def test_modify_deployment_config_image_only(self):
        ...
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['image'], 'nginx:1.22')
    ...
    def test_modify_deployment_config_replicas_only(self):
        ...
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['image'], 'nginx:latest')  # Original value
    ...
    def test_modify_deployment_config_resource_limits_only(self):
        ...
        self.assertEqual(deployment['spec']['replicas'], 1)  # Original value
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['image'], 'nginx:latest')  # Original value
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['limits']['cpu'], '1000m')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['limits']['memory'], '1Gi')
    ...
    def test_modify_deployment_config_resource_requests_only(self):
        ...
        self.assertEqual(deployment['spec']['replicas'], 1)  # Original value
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['image'], 'nginx:latest')  # Original value
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['requests']['cpu'], '500m')
        self.assertEqual(deployment['spec']['template']['spec']['containers'][0]['resources']['requests']['memory'], '512Mi')
    ...
    @patch('kind_cluster_setup.commands.modify.get_environment_config')
    @patch('kind_cluster_setup.commands.modify.Command.__init__')
    def test_modify_deployment_app_not_found(self, mock_init, mock_get_env_config, mock_load_app_config):
    ...
    @patch('kind_cluster_setup.commands.modify.get_environment_config')
    @patch('kind_cluster_setup.commands.modify.Command.__init__')
    def test_modify_deployment_cluster_not_found(self, mock_init, mock_get_env_config, mock_load_app_config):
    ...
    @patch('kind_cluster_setup.commands.modify.SubprocessCommandExecutor')
    @patch('kind_cluster_setup.commands.modify.Command.__init__')
    def test_modify_deployment_strategy_failure(self, mock_init, mock_executor, mock_factory, mock_get_env_config, mock_load_app_config):
