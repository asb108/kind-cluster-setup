...
class TestCLIParser(unittest.TestCase):
    ...
    def test_modify_command(self):
        args = self.parser.parse_args(['modify', '--environment', 'dev', '--app', 'test-app', '--image', 'nginx:1.21', '--replicas', '2'])
    ...
    def test_delete_app_command(self):
        args = self.parser.parse_args(['delete-app', '--environment', 'dev', '--app', 'test-app', '--force'])
