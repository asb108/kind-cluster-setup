...
class ApiServerAdapter:
    ...
    def __init__(self):
        ...
        self.deployment_factory = DeploymentStrategyFactory.create_default_factory(self.executor)
    ...
    def create_cluster(self, 
        ...
        try:
            ...
            if control_plane_config:
                cluster_config.control_plane_config.cpu = control_plane_config.get('cpu', '1')
                cluster_config.control_plane_config.memory = control_plane_config.get('memory', '2GB')
    ...
    def delete_application(self,
                          ...
                          app_name: str,
                          namespace: str,
                          deployment_method: str = "helm") -> Dict[str, Any]:
        """
