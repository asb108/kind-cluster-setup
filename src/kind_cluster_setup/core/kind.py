...
class KindClient:
    ...
    def create_cluster(self, 
                      ...
                      wait: Optional[str] = None) -> CommandResult:
        """
    ...
    def export_kubeconfig(self, 
                         ...
                         internal: bool = False) -> CommandResult:
        """
    ...
    def load_docker_image(self, 
                         image_name: str,
                         cluster_name: str) -> CommandResult:
        """
        ...
        """
        # Execute the command
        return self.execute(["load", "docker-image", image_name, "--name", cluster_name])
