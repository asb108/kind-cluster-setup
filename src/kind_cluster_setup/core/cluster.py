...
class ClusterManager:
    ...
    def create_cluster(self, 
                      ...
                      env_config: EnvironmentConfig) -> 'Cluster':
        """
    ...
    def _create_kind_config(self, cluster_config: ClusterConfig) -> Dict[str, Any]:
        ...
        control_plane_node = {
            ...
            'extraPortMappings': [
                {'containerPort': 80, 'hostPort': cluster_config.http_port, 'protocol': 'TCP'},
                {'containerPort': 443, 'hostPort': cluster_config.https_port, 'protocol': 'TCP'},
                {'containerPort': 30080, 'hostPort': cluster_config.nodeport_start, 'protocol': 'TCP'}
            ]
        }
